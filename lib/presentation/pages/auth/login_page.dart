...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<AuthState>(authProvider, (previous, next) {
      ...
      final wasLoggedIn =
          previous?.user != null || (previous?.isGuest ?? false);
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          // ── Dark + blur overlay ──────────────────────────────────────
          if (AdaptivePerformance.enableBackdropBlur)
            BackdropFilter(
            ...
            Container(color: AppColors.bg0.withAlpha(220)),
                  ...
                  builder: (context) {
                    final content = Container(
                      ...
                      decoration: BoxDecoration(
                        color: AdaptivePerformance.enableBackdropBlur ? AppColors.glassFill : AppColors.glassFill.withAlpha(240),
                        borderRadius: BorderRadius.circular(28),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ).animate().fade(duration: 600.ms, delay: 100.ms).scale(
