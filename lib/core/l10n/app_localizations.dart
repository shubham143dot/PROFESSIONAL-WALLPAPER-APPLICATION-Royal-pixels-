...
abstract class AppLocalizations {
  ...
  /// No description provided for @allLanguagesCount.
  ///
  /// In en, this message translates to:
  /// **'ALL LANGUAGES ({count})'**
  String allLanguagesCount(int count);

  /// No description provided for @noLanguageFoundFor.
  ///
  /// In en, this message translates to:
  /// **'No language found for \"{query}\"'**
  String noLanguageFoundFor(String query);

  /// No description provided for @followYourPhonesSystemLanguage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @sevenDayTotalUsers.
  ///
  /// In en, this message translates to:
  /// **'7-day total: {count} users'**
  ...
  /// No description provided for @sevenDayTotal.
  ///
  /// In en, this message translates to:
  /// **'7-Day Total'**
  String get sevenDayTotal;
