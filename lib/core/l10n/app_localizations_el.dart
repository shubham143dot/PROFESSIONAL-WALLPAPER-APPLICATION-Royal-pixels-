...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get setWallpaper => 'Ορισμός ταπετσαρίας';
  ...
  @override
  String get contactSupport => 'Επικοινωνία υποστήριξης';
  ...
  @override
  String get likes => 'Μου αρέσει';

  @override
  String get wallpapers => 'Ταπετσαρίες';
  ...
  @override
  String get social => 'Κοινωνική ροή';

  @override
  String get myWallpapers => 'Οι ταπετσαρίες μου';

  @override
  String get diamonds => 'Διαμάντια';
  ...
  @override
  String get helpSupport => 'Βοήθεια και υποστήριξη';

  @override
  String get legalPolicy => 'Νομική πολιτική';

  @override
  String get legalInfo => 'Νομικές πληροφορίες';
  ...
  @override
  String get developedBy => 'Αναπτύχθηκε από Royal Shubham Pixel Labs';

  @override
  String get premiumWallpapers => 'Premium ταπετσαρίες για τη συσκευή σας';

  @override
  String get selectLanguage => 'Επιλογή γλώσσας';

  @override
  String get languageChanged => 'Η γλώσσα άλλαξε επιτυχώς';

  @override
  String get deviceLanguage => 'Γλώσσα συσκευής';
