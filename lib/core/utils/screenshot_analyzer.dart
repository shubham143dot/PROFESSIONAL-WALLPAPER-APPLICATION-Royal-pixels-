...
class ScreenshotAnalyzer {
  ...
  static Future<ScreenshotAnalysisResult> analyzePaymentScreenshot(
    ...
    try {
      ...
      final phonePeRegex =
          RegExp(r'(?<![A-Za-z0-9])T\d{15,22}(?!\d)', caseSensitive: false);
      ...
      if (phonePeRegex.hasMatch(text)) {
        ...
        final matches =
            utrRegex.allMatches(text).map((m) => m.group(0)!).toList();
